(function(){
 "use strict";
 const VERSION="1.0.0"; const URL="/registry/content-operations.json"; let cache=null;
 ...
 window.CasaContentOperations={version:VERSION,load,queue,validate,snapshot,get data(){return cache}};window.CasaCore?.modules?.register?.({id:"content-operations",version:VERSION,capabilities:["content.queue","review.queue","publish.queue","impact.analysis","ai.actions"]});load().catch(e=>window.CasaEvents?.publish?.("content-operations:error",{message:e.message}));
})();
