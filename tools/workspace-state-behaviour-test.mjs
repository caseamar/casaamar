...
check(source.includes("const RELEASE='v2026.07.24.165'"),'Return state must be bound to the current release');
...
for(const page of ['recommendation-engine.html','asset-intelligence.html','knowledge-graph.html','experience-engine.html','release-governance.html']){
 ...
 check(html.includes('/core/casa-workspace-state.js?v=20260724.165'),page+' must load workspace state manager');
