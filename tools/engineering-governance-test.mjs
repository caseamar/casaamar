...
const source=fs.readFileSync(path.join(root,"core/casa-engineering-governance.js"),"utf8");check(source.includes('const VERSION="1.2.0"'),"Engineering Governance runtime version matches");
