...
(() => {
  ...
  const items = [
    ...
    {id:'restaurant-cerros',type:'restaurant',role:'dining',title:'Restaurant Cerros del Águila',summary:'Lokalt spisested tæt på huset til morgenmad, frokost, middag eller en drink.',duration:d(45,90,150),energy:1,location:'cerros',locationLabel:'Cerros del Águila',tags:['mad','rolig','familie','lokal','terrasse'],mealMoments:['breakfast','lunch','dinner','drinks'],primaryIntents:['breakfast','lunch','dinner','evening','local'],secondaryIntents:['family','calm'],relatedIntents:['golf','pool'],windows:[w(600,1380)],preferredStart:720,participants:['all','subgroup']},
    ...
    {id:'hoyo19',type:'restaurant',role:'dining',title:'Hoyo 19',summary:'Lokalt sted tæt på huset til morgenmad, frokost, middag eller en drink.',duration:d(45,90,150),energy:1,location:'cerros',locationLabel:'Cerros del Águila',tags:['mad','rolig','familie','lokal','golf','terrasse'],mealMoments:['breakfast','lunch','dinner','drinks'],primaryIntents:['breakfast','lunch','dinner','evening','local'],secondaryIntents:['family','calm','golf'],relatedIntents:['pool'],windows:[w(480,1380)],preferredStart:720,participants:['all','subgroup'],pairs:['home-pool','roof-sunset']},
