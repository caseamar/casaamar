...
(() => {
  ...
  const items = [
    ...
    {id:'hoyo-breakfast',hiddenFromSuggestions:true,type:'meal',role:'breakfast',exclusiveGroup:'meal.breakfast',maxPerDay:1,title:'Morgenmad på Hoyo 19',summary:'En lokal morgenmad tæt på huset fra kl. 08.',duration:d(45,75,105),energy:1,location:'cerros',locationLabel:'Cerros del Águila',tags:['mad','rolig','familie'],windows:[w(480,720)],preferredStart:510,participants:['all','subgroup']},
    {id:'restaurant-cerros',type:'restaurant',role:'dining',title:'Restaurant Cerros del Águila',summary:'Lokalt spisested tæt på huset med servering fra formiddag til aften.',duration:d(45,90,150),energy:1,location:'cerros',locationLabel:'Cerros del Águila',tags:['mad','rolig','familie','lokal','terrasse'],mealMoments:['breakfast','lunch','dinner','drinks'],primaryIntents:['breakfast','lunch','dinner','evening','local'],secondaryIntents:['family','calm'],relatedIntents:['golf','pool'],windows:[w(600,1380)],preferredStart:720,participants:['all','subgroup'],intentWeights:{breakfast:72,lunch:86,dinner:96,evening:94,local:92}},
    ...
    {id:'hoyo19',type:'restaurant',role:'dining',title:'Hoyo 19',summary:'Restaurant ved golfbanen med morgenmad, frokost, middag og drinks.',duration:d(45,90,150),energy:1,location:'cerros',locationLabel:'Cerros del Águila',tags:['mad','rolig','familie','lokal','golf','terrasse'],mealMoments:['breakfast','lunch','dinner','drinks'],primaryIntents:['breakfast','lunch','dinner','evening','local'],secondaryIntents:['family','calm','golf'],relatedIntents:['pool'],windows:[w(480,1380)],preferredStart:720,participants:['all','subgroup'],pairs:['home-pool','roof-sunset'],intentWeights:{breakfast:98,lunch:94,dinner:84,evening:82,local:90,golf:100}},
    {id:'la-cala-restaurant',type:'restaurant',role:'lunch',exclusiveGroup:'meal.lunch',maxPerDay:1,title:'Frokost i La Cala',summary:'Spis tæt på vandet og kombiner med strand eller promenade.',duration:d(60,120,150),energy:1,location:'la-cala',locationLabel:'La Cala',tags:['mad','kyst'],mealMoments:['lunch','dinner'],primaryIntents:['lunch','dinner'],secondaryIntents:['coast'],relatedIntents:['beach'],windows:[w(750,1380)],preferredStart:810,participants:['all','subgroup'],pairs:['la-cala-beach']},
  ...
  const discovery = {
    'restaurant-cerros': {intentWeights:{breakfast:72,lunch:86,dinner:96,evening:94,local:92},discoveryGroup:'dining'},
    'hoyo19': {intentWeights:{breakfast:98,lunch:94,dinner:84,evening:82,local:90,golf:100},discoveryGroup:'dining'},
