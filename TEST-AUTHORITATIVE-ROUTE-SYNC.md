...
3. Åbn `/api/platform-meta`; den skal vise `v2026.07.24.94`.
4. Åbn `/platform-manifest.json`; den skal vise `v2026.07.24.94` og samme worker/build.
5. Åbn både:
   - `/knowledge-center`
   - `/knowledge-center.html`
6. Begge adresser skal vise `v2026.07.24.94` og samme build-tid.
7. Sidens kilde skal indlæse `platform-shell.js?v=20260724.94`.
