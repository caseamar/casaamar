...
export default {
  async fetch(request, env) {
    ...
    if (request.method === "GET" && url.pathname === "/api/platform-meta") {
      return json({
        ok: true,
        platform_version: "v2026.07.24.103",
        build: "2026-07-27T15:29:05+02:00",
        worker_version: "15.3-platform-doctor",
