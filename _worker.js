...
async function handleStatus(request, env) {
  try {
    ...
    return json({
      ...
      version: "15.10.0-decision-audit-event-contracts",
  ...
  async fetch(request, env) {
    ...
    if (request.method === "GET" && url.pathname === "/api/page-health") {
      try {
        ...
        return json({
          ok: true,
          worker: "15.10.0-decision-audit-event-contracts",
    ...
    if (request.method === "GET" && url.pathname === "/api/platform-meta") {
      return json({
        ok: true,
        platform_version: "v2026.07.24.114",
        build: "2026-07-27T20:25:00+02:00",
        worker_version: "15.10.0-decision-audit-event-contracts",
