...
async function handleStatus(request, env) {
  try {
    ...
    return json({
      ...
      version: "15.4-doctor-completion-confirmation",
  ...
  async fetch(request, env) {
    ...
    if (request.method === "GET" && url.pathname === "/api/page-health") {
      try {
        ...
        return json({
          ok: true,
          worker: "15.4-doctor-completion-confirmation",
    ...
    if (request.method === "GET" && url.pathname === "/api/platform-meta") {
      return json({
        ok: true,
        platform_version: "v2026.07.24.104",
        build: "2026-07-27T15:51:06+02:00",
        worker_version: "15.4-doctor-completion-confirmation",
