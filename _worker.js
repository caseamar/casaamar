...
async function handleStatus(request, env) {
  try {
    ...
    return json({
      ...
      version: "15.8-platform-intelligence-foundation",
  ...
  async fetch(request, env) {
    ...
    if (request.method === "GET" && url.pathname === "/api/page-health") {
      try {
        ...
        return json({
          ok: true,
          worker: "15.8-platform-intelligence-foundation",
    ...
    if (request.method === "GET" && url.pathname === "/api/platform-meta") {
      return json({
        ok: true,
        platform_version: "v2026.07.24.108",
        build: "2026-07-27T17:22:36+02:00",
        worker_version: "15.8-platform-intelligence-foundation",
