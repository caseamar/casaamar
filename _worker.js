...
async function handleStatus(request, env) {
  try {
    ...
    return json({
      ...
      version: "15.14.0-release-navigation-consistency-hotfix",
  ...
  async fetch(request, env) {
    ...
    if (request.method === "GET" && url.pathname === "/api/page-health") {
      try {
        ...
        return json({
          ok: true,
          worker: "15.20-content-studio-foundation",
    ...
    if (request.method === "GET" && url.pathname === "/api/platform-meta") {
      return json({
        ok: true,
        platform_version: "v2026.07.24.144",
        build: "2026-07-28T11:14:00+02:00",
        worker_version: "15.32-workspace-return-navigation-simplification-hotfix",
