...
export default {
  async fetch(request, env) {
    ...
    if (request.method === "GET" && url.pathname === "/api/platform-meta") {
      return json({
        ok: true,
        platform_version: "v2026.07.24.102",
        build: "2026-07-27T15:07:44+02:00",
        worker_version: "15.2-casa-amar-core",
